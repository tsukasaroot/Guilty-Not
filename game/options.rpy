...
define config.name = _("GuiltyNot")
...
define config.voice_filename_format = "ev/{filename}.mp3"
define config.main_menu_music = "bgm/menu_bgm.mp3"
...
define config.save_directory = "GuiltyNot-1552992494"
